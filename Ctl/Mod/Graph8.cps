...
**)
    ...
    (* Microsoft Graph 8.0 Object Library, help: E:\MsOffice\Office\VBAGRP8.HLP, id: 65535 *)
    (* guid: {00020802-0000-0000-C000-000000000046}, lcid: 0, syskind: win32, version: 1.2 *)
    ...
    PROCEDURE (this: Application) PUTDataSheet* (p1: DataSheet), NEW;
        VAR arg: ARRAY 1 OF CtlT.Variant;
    BEGIN
        CtlC.ObjVar(p1, arg[0]);
        CtlC.CallParMethod(this, 1101, arg, NIL);
    END PUTDataSheet;
    ...
    PROCEDURE (this: DataSheet) PUTFont* (p1: Font), NEW;
        VAR arg: ARRAY 1 OF CtlT.Variant;
    BEGIN
        CtlC.ObjVar(p1, arg[0]);
        CtlC.CallParMethod(this, 146, arg, NIL);
    END PUTFont;
